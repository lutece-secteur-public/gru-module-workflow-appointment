...
public class TaskNotifyAppointementCrm extends SimpleTask {
	...
	public void processTask(int nIdResourceHistory, HttpServletRequest request, Locale locale) {
		...
		if (config != null) {
			...
			try {
				strIdDemand = _crmClientService.sendCreateDemandByUserGuid(config.getDemandeType(),
						Integer.toString(appointment.getIdUser()), config.getIdStatusCRM(), config.getStatusText(),
						config.getData());
